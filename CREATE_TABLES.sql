...
CONSTRAINT FK_CLI1 FOREIGN KEY (COD_CIDADE) REFERENCES CIDADE (COD_CIDADE),
CONSTRAINT FK_CLI2 FOREIGN KEY (COD_EMPRESA) REFERENCES EMPRESA (COD_UF),
)
GO
...
CONSTRAINT FK_MAT1 FOREIGN KEY (COD_EMPRESA,COD_TOP_MAT) REFERENCES TIPO_MAT (COD_EMPRESA,COD_TIP_MAT)
)
GO
...
DATA_INI DATE,
DATA_FIM DATE,
SITUACAO CHAR(1) CONSTRAINT CK_TC1 CHECK (TIPO_CLIENTE IN ('A','P','F')), --A-ABERTA, P-PLANEJADA, F-FECHADA
...
--CRIANDO TABELAS APONTAMENTOS PROD
